...
func (rep *StarRepository) Create(star *models.Star) (err error) {
	err = sqlDatabaseConnection.Create(star).Error
	if err != nil {
...
func (rep *StarRepository) Delete(fileID, userID int64) (err error) {
	err = sqlDatabaseConnection.Delete(&models.Star{FileID: fileID, UserID: userID}).Error
	if err != nil {
...
func (rep *StarRepository) Exists(fileID, userID int64) (exists bool, err error) {
	err = sqlDatabaseConnection.First(&models.Star{FileID: fileID, UserID: userID}).Error
...
func (rep *StarRepository) Count() (count int64, err error) {
	err = sqlDatabaseConnection.Model(&models.Star{}).Count(&count).Error
	if err != nil {
