...
// CreateFileParams contains all the bound params for the create file operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateFileParams() beforehand.
func (o *CreateFileParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
