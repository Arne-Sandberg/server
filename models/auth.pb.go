...
func (*LoginData) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_745740db0b17cbfa, []int{0}
}
...
func init() { proto.RegisterFile("auth.proto", fileDescriptor_auth_745740db0b17cbfa) }

var fileDescriptor_auth_745740db0b17cbfa = []byte{
